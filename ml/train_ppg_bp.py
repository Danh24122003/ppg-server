...
# Cau hinh
# ============================================================
PROJECT_ROOT = HERE.parent.parent  # HERE = ml/, root project = HERE.parent.parent
...
# Self-collected reflectance data (MAX30102) - sinh ra tu backend/self_collect/log_ppg_local.py
...
def load_self_collected_features(
    ...
    for csv_path in csv_files:
        ...
        # Reason: firmware co the drift sample rate (vd S10: claimed 104 nhung thuc te 80.7)
...
def main() -> int:
    ...
    # Don file tu layout 2-bundle cu de tranh confusion
    out_dir = Path(MODEL_DIR)
    if not out_dir.is_absolute():
        out_dir = HERE / out_dir
    legacy_files = (
