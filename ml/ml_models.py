...
Dự đoán: S05ết áp (BP), SpO2, Nhịp tim (HR/HRV/AFib), Stress, Glucose
"""
...
class PredictionResult:
    ...
    sbp: float = 0.0              # S05ết áp tâm thu (mmHg)
    dbp: float = 0.0              # S05ết áp tâm trương (mmHg)
...
class ClassicalMLModel(BasePPGModel):
    ...
    def _predict_rule_based(self, features: PPGFeatures) -> Dict[str, float]:
        ...
        # S05ết áp: ước tính từ pulse transit time proxy (rise time, morphology)
